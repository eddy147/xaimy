defmodule XaimyWeb.ChatbotLive do
  ...
  @impl true
  def handle_info({Xaimy.ChatbotLive.FormComponent, {:saved, message}}, socket) do
    messages = [message | socket.assigns.messages]
    Task.async(fn -> Chatbot.generate_response(socket.assigns.conversation, messages) end)
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-t-lg overflow-hidden">
      ...
      <div class="bg-gray-300 p-4">
        <.live_component
          module={XaimyWeb.ChatbotLive.FormComponent}
          id="new-message"
